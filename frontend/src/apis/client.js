...
export const fetchListAllClientRepo = async () => {
	const url = `${SERVER_URL}user/client/projects`;
...
export const fetchProjectProgress = async (projectId) => {
	try {
		...
		const progressDetails = await axios.get(url, {
			params: {
...
export const fetchProjectDetails = async (projectId) => {
	const url = `${SERVER_URL}user/client/projectDets`;
...
async function fetchGitHubRepoFiles(fullName) {
	try {
		...
		if (!response.ok) {
			throw new Error(
				`Failed to fetch repository files. Status: ${response.status}`
			);
		}
...
export const fetchFilesFromRepo = async (projectId) => {
	const url = `${SERVER_URL}user/client/projectName`;
...
export async function fetchGitHubFile(projectId, path) {
	try {
		...
		if (!response.ok) {
			throw new Error(
				`Failed to fetch file contents. Status: ${response.status}`
			);
		}
		const data = await response.json();
		if (data.content) {
...
export const fetchClientDocs = async (projectId) => {
	try {
		const url = `${SERVER_URL}user/client/docs`;
...
export const postClientDocs = async (projectId, docs) => {
	try {
		const url = `${SERVER_URL}user/client/docs`;
